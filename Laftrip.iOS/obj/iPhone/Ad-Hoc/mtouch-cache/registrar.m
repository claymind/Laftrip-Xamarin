...
native_to_managed_trampoline_Xamarin_Auth_WebAuthenticatorController_WebViewDelegate_LoadFailed (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_51, 1));
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_SDWebImage_SDWebImageManager__SDWebImageManagerDelegate_ShouldDownloadImageForURL (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_54, 1));
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_SDWebImage_SDWebImageManager__SDWebImageManagerDelegate_TransformDownloadedImage (id this, SEL sel, id p0, id p1, id p2)
{
	...
	NSObject *nsobj2 = (NSObject *) p2;
		...
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr (nsobj2, false, monotouch_get_parameter_type (method_55, 2));
		}
		arg_ptrs [2] = mobj2;
...
native_to_managed_trampoline_GoogleAdMobAds_GADCustomEventBanner__GADCustomEventBannerDelegate__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_59));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_Xamarin_Social_CheckedPickerView_PickerDelegate_GetView (id this, SEL sel, id p0, int p1, int p2, id p3)
{
	...
	NSObject *nsobj3 = (NSObject *) p3;
		...
		if (nsobj3) {
			mobj3 = get_nsobject_with_type_for_ptr (nsobj3, false, monotouch_get_parameter_type (method_75, 3));
		}
		arg_ptrs [3] = mobj3;
...
native_to_managed_trampoline_MonoTouch_Dialog_ImageElement_MyDelegate_FinishedPickingImage (id this, SEL sel, id p0, id p1, id p2)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_92, 1));
		}
		arg_ptrs [1] = mobj1;
	NSObject *nsobj2 = (NSObject *) p2;
		MonoObject *mobj2 = NULL;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr (nsobj2, false, monotouch_get_parameter_type (method_92, 2));
		}
		arg_ptrs [2] = mobj2;
...
native_to_managed_trampoline_MonoTouch_Dialog_DialogViewController_Source_WillDisplay (id this, SEL sel, id p0, id p1, id p2)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_107, 1));
		}
		arg_ptrs [1] = mobj1;
	NSObject *nsobj2 = (NSObject *) p2;
		MonoObject *mobj2 = NULL;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr (nsobj2, false, monotouch_get_parameter_type (method_107, 2));
		}
		arg_ptrs [2] = mobj2;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIImagePickerController__UIImagePickerControllerDelegate_FinishedPickingImage (id this, SEL sel, id p0, id p1, id p2)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_132, 1));
		}
		arg_ptrs [1] = mobj1;
	NSObject *nsobj2 = (NSObject *) p2;
		MonoObject *mobj2 = NULL;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr (nsobj2, false, monotouch_get_parameter_type (method_132, 2));
		}
		arg_ptrs [2] = mobj2;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIImagePickerController__UIImagePickerControllerDelegate_WillShowViewController (id this, SEL sel, id p0, id p1, bool p2)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_135, 1));
		}
		arg_ptrs [1] = mobj1;
	arg_ptrs [2] = &p2;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIImagePickerController__UIImagePickerControllerDelegate_GetAnimationControllerForOperation (id this, SEL sel, id p0, int p1, id p2, id p3)
{
	...
	NSObject *nsobj2 = (NSObject *) p2;
		MonoObject *mobj2 = NULL;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr (nsobj2, false, monotouch_get_parameter_type (method_140, 2));
		}
		arg_ptrs [2] = mobj2;
	NSObject *nsobj3 = (NSObject *) p3;
		MonoObject *mobj3 = NULL;
		if (nsobj3) {
			mobj3 = get_nsobject_with_type_for_ptr (nsobj3, false, monotouch_get_parameter_type (method_140, 3));
		}
		arg_ptrs [3] = mobj3;
...
native_to_managed_trampoline_Laftrip_iOS_MenuTableViewControllerSource_GetCell (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr (nsobj0, false, monotouch_get_parameter_type (method_158, 0));
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_158, 1));
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_Laftrip_iOS_MenuTableViewControllerSource_RowSelected (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_159, 1));
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_Laftrip_iOS_JokesSearchViewController__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_167));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_Laftrip_iOS_PhotosSearchViewController_myDataSource_GetCell (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_181, 1));
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_Laftrip_iOS_PhotosSearchViewController_set_txtSearch (id this, SEL sel, id p0)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr (nsobj0, false, monotouch_get_parameter_type (method_186, 0));
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UITextView__UITextViewDelegate_ShouldInteractWithUrl (id this, SEL sel, id p0, id p1, NSRange p2)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_258, 1));
		}
		arg_ptrs [1] = mobj1;
	arg_ptrs [2] = &p2;
...
native_to_managed_trampoline_MonoTouch_UIKit_UITextView__UITextViewDelegate_ShouldInteractWithTextAttachment (id this, SEL sel, id p0, id p1, NSRange p2)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_259, 1));
		}
		arg_ptrs [1] = mobj1;
	arg_ptrs [2] = &p2;
...
native_to_managed_trampoline_MonoTouch_UIKit_UITextView__UITextViewDelegate_ZoomingEnded (id this, SEL sel, id p0, id p1, float p2)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_269, 1));
		}
		arg_ptrs [1] = mobj1;
	arg_ptrs [2] = &p2;
...
native_to_managed_trampoline_MonoTouch_UIKit_UITextView__UITextViewDelegate_ZoomingStarted (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_271, 1));
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_Dialog_DialogViewController_SizingSource_GetHeightForRow (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr (nsobj0, false, monotouch_get_parameter_type (method_277, 0));
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_277, 1));
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_Laftrip_iOS_MenuTableViewControllerController__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_284));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_Xamarin_Social_ShareViewController_LabelButton_TouchesBegan (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr (nsobj0, false, monotouch_get_parameter_type (method_288, 0));
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_288, 1));
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_Xamarin_Social_ShareViewController_LabelButton_TouchesEnded (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr (nsobj0, false, monotouch_get_parameter_type (method_289, 0));
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_289, 1));
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_Laftrip_iOS_AddJokeView__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_296));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_Laftrip_iOS_AddPhotoView__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_297));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
void *
native_to_managed_trampoline_Laftrip_iOS_UserPreferencesView__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
native_to_managed_trampoline_MonoTouch_Dialog_GlassButton_BeginTracking (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr (nsobj0, false, monotouch_get_parameter_type (method_301, 0));
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_301, 1));
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_Dialog_GlassButton_EndTracking (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr (nsobj0, false, monotouch_get_parameter_type (method_302, 0));
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_302, 1));
		}
		arg_ptrs [1] = mobj1;
...
static MTClassMap __monotouch_class_map [] = {
	...
	{"Laftrip.iOS.UserPreferencesView", "Laftrip.iOS.UserPreferencesView, LaftripiOS", 0},
...
static MTClass __monotouch_classes [] = {
	...
	{"Settings", "UIViewController", 1, 2, 0},
	...
	{"Laftrip.iOS.UserPreferencesView", "MonoTouch.Dialog.DialogViewController", 1, 1, 0},
...
static MTMethod __monotouch_methods [] = {
	...
	{"init","@@:",0, &native_to_managed_trampoline_Laftrip_iOS_UserPreferencesView__ctor},
...
int __monotouch_map_count = 196;
static int __monotouch_class_count = 82;
